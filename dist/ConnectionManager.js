...
class ConnectionManager {
    ...
    connect(providerType, chainId = types_1.ChainId.MAINNET) {
    ...
    createProvider(providerType, chainId = types_1.ChainId.MAINNET) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getConnector(providerType, chainId) {
        switch (providerType) {
    ...
    toProvider(provider) {
        ...
        if (this.isLegacyProvider(provider)) {
            newProvider.request = ({ method, params }) => provider.send(method, params);
        }
        return newProvider;
    }
    isLegacyProvider(provider) {
        return (typeof provider['request'] === 'undefined' &&
